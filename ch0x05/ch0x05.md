...
```bash
# 安装依赖
sudo apt -y install gcc make python3 libssl-dev libssl1.1 libpcre3-dev unzip zlib1g-dev git clone git clone https://github.com/alexazhou/VeryNginx.git
...
然后就可以用`dvwa.sec.cuc.edu.cn`,`wp.sec.cuc.edu.cn`访问了。
